namespace EgyptianeInvoicing.Shared.Dtos
{
    public class ImportedInvoiceItemDto
    {
        ...
        public double VATPercentage { get; set; } = 0;         // نسبة ضريبة القيمة المضافة
        public double RelativeTableTaxPercentage { get; set; } = 0; // نسبة ضريبة الجدول النسبية
        public double SpecificTableTaxPercentage { get; set; } = 0; // نسبة ضريبة الجدول النوعية
        public string? DiscountTaxCode { get; set; }        // كود الخصم تحت حساب الضريبة
        public double DiscountTaxPercentage { get; set; } = 0; // نسبة الخصم تحت حساب الضريبة
    }
}
